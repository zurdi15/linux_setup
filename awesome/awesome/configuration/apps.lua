...
return {
	...
	default = {
		...
		rofiweb			= 'rofi -dpi ' .. screen.primary.dpi .. ' -show Search -modi Search:' .. config_dir .. '/configuration/rofi/sidebar/rofi-web-search.py' .. ' -theme ' .. config_dir .. '/configuration/rofi/sidebar/rofi.rasi',   -- Rofi Web Search
		rofiappmenu 		= 'rofi -dpi ' .. screen.primary.dpi .. ' -show drun -display-drun ">> " -theme ' .. config_dir .. '/configuration/rofi/appmenu/rofi.rasi'   -- Application Menu
